        ...
        <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    <div className="flex">
                        <Link href="/engines" className="flex-shrink-0 flex items-center font-bold text-xl text-slate-900">
                            SignalEngines
                        </Link>
                        <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                            ...
                            <a href="https://warmup.signalengines.com" target="_blank" rel="noopener noreferrer" className="border-transparent text-slate-500 hover:text-orange-600 hover:border-orange-300 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                                Warmup Hero
                            </a>
                        </div>
                    </div>
